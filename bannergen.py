...
app.enable_performance_header = "enable_performance_header" in args.__dict__ and args.enable_performance_header
app.memory_threshold = args.memory_threshold if "memory_threshold" in args.__dict__ else 0
